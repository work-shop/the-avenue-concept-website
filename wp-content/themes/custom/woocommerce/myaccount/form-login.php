...
<?php if ( get_option( 'woocommerce_enable_myaccount_registration' ) === 'yes' ) : ?>
	...
	<div class="u-columns col2-set row" id="customer_login">
		...
		<div class="col-md-6 offset-md-3 col-xl-4 offset-xl-0 login-register-help mb2 d-flex justify-content-center hidden-sm">
			<h3 class="bold">
				Please log in, <br>
				or create a new account.
				<br>
				<a href="/contact" target="_blank" class="button mt1">Questions? Contact Us.</a>
			</h3>
		</div>

		<div class="u-column1 col-1-broken col-md-6 offset-md-3 col-xl-4 offset-xl-0">
		<?php endif; ?>
		<!--login form-->
		...
		<!--registration form-->
		<div class="u-column2 col-2-broken col-md-6 offset-md-3 col-xl-4 offset-xl-0">
